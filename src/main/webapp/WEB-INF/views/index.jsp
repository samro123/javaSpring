...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href='<c:url value = "/resources/Styles/styles_index.css"/>'/>
  ...
  <body>
    ...
    <header>
      <div class="section__container header__container">
        ...
        <div class="header__image">
          <img src='<c:url value = "/resources/Image/assets/header.png"/>' alt="header" />
        </div>
      </div>
    </header>

    <section class="section__container collection__container">
      <img src='<c:url value = "/resources/Image/assets/collection.jpg"/>' alt="collection" />
    ...
    <section class="section__container sale__container">
      ...
      <div class="sale__grid">
        <div class="sale__card">
          <img src='<c:url value = "/resources/Image/assets/sale-1.jpg"/>' alt="sale" />
        ...
        <div class="sale__card">
          <img src='<c:url value = "/resources/Image/assets/sale-2.jpg"/>' alt="sale" />
          <div class="sale__content">
        ...
        <div class="sale__card">
          <img src='<c:url value = "/resources/Image/assets/sale-3.jpg"/>' alt="sale" />
          <div class="sale__content">
      ...
      <div class="section__container news__container">
        ...
        <div class="news__grid">
          <div class="news__card">
            <img src='<c:url value = "/resources/Image/assets/news-1.jpg"/>' alt="news" />
          ...
          <div class="news__card">
            <img src='<c:url value = "/resources/Image/assets/news-2.jpg"/>' alt="news" />
            <div class="news__details">
              <p>
          ...
          <div class="news__card">
            <img src='<c:url value = "/resources/Image/assets/news-3.jpg"/>' alt="news" />
            <div class="news__details">
              <p>
    ...
    <section class="section__container brands__container">
      <div class="brand__image">
        <img src='<c:url value = "/resources/Image/assets/brand-1.png"/>' alt="brand" />
      </div>
      <div class="brand__image">
        <img src='<c:url value = "/resources/Image/assets/brand-2.png"/>' alt="brand" />
      </div>
      <div class="brand__image">
        <img src='<c:url value = "/resources/Image/assets/brand-3.png"/>' alt="brand" />
      </div>
      <div class="brand__image">
        <img src='<c:url value = "/resources/Image/assets/brand-4.png"/>' alt="brand" />
      </div>
      <div class="brand__image">
        <img src='<c:url value = "/resources/Image/assets/brand-5.png"/>' alt="brand" />
      </div>
      <div class="brand__image">
        <img src='<c:url value = "/resources/Image/assets/brand-6.png"/>' alt="brand" />
      </div>
    </section>
    ...
    <footer class="section__container footer__container">
      ...
      <div class="footer__col">
        ...
        <div class="instagram__grid">
          <img src='<c:url value = "/resources/Image/assets/instagram-1.jpg"/>' alt="instagram" />
          <img src='<c:url value = "/resources/Image/assets/instagram-2.jpg"/>' />
          <img src='<c:url value = "/resources/Image/assets/instagram-3.jpg"/>' />
          <img src='<c:url value = "/resources/Image/assets/instagram-4.jpg"/>' />
          <img src='<c:url value = "/resources/Image/assets/instagram-5.jpg"/>' />
          <img src='<c:url value = "/resources/Image/assets/instagram-6.jpg"/>' />
        </div>
      </div>
    </footer>
